const PROJECT_DATA = [
  {
    ...
    items: [
      ...
      },
      {
        ...
        size: "",
        linkUrl:
          "https://github.com/himanshukj17122000/Android-Visitor-Management-",
      ...
      },
      {
        ...
        linkUrl:
          "https://www.amazon.com/Friendship-Beyond-Borders-Ayela-Chughtai-ebook/dp/B07G797MF7",
...

      {
        ...
        size: "",
        linkUrl:
          "https://igs.duke.edu/events/smart-archaeology-uncovering-secrets-beneath-surface",
    ...
    items: [
      {
        ...
        linkUrl:
          "https://marketplace.visualstudio.com/items?itemName=webStarter.webStarter",
        size: "",
        info:
          "I made 2 extensions- Web Animations and Corona Recovery Stats for the Vscode. Web Animations allows users to get starter code for 5+ Web Animations that are made using different JavaScript libraries. Corona Recovery Stats allows the user to get the number of recoveries as well as the rate of recovery in any country they want. This information is show in their status bar.",
        name: "Black Jean Shearling",
        imageUrl:
          "https://i.ibb.co/Fz2d9QC/Screenshot-2020-04-29-at-5-19-01-PM.png",
        price: 125,
      },
      {
        id: 22,
        ...
        size: "",
        info:
          "I made a weather app using Node, Express, handlebars and CSS. This allows the user to get information about the weather of any place just by inputting the name of the city. The app uses 2 different APIs for getting the live weather of any place chosen by the user.",
        name: "Tan Trench",
        imageUrl:
          "https://i.ibb.co/pfznssD/Screenshot-2020-04-29-at-5-25-12-PM.png",
        price: 185,
      },
      {
        id: 23,
        ...
        info:
          "A webapp that is able to find the Github users using the username. You can visit the profile of the user and read about the repositories of the user. The app is hosted on Netlify and has been made using React.js, HTML, and CSS",
        name: "Blue Tanktop",
        imageUrl:
          "https://i.ibb.co/m0XPYWv/Screenshot-2020-04-29-at-5-25-42-PM.png",
        price: 25,
      },
      {
        id: 24,
      ...
      },
      {
        ...
        info:
          "This web scraper was made in Python that could be run using CLI.",
        size: "",
        name: "White Blouse",
        imageUrl:
          "https://i.ibb.co/zJ5CgJN/Screenshot-2020-04-29-at-5-38-21-PM.png",
        price: 20,
      },
    ],
  },
    ...
    items: [
      {
        ...
        size: "",
        info:
          "Allows users to play a variety of games within a similar genre. Cards against Humanity, Solitaire, Memory, Truth and Dare are some of the games that can be played.",
        name: "Floral Dress",
        imageUrl:
          "https://i.ibb.co/hsp1xTc/Screenshot-2020-04-29-at-5-28-25-PM.png",
        price: 80,
      },
      {
        id: 26,
        ...
        info:
          "A 2D game of Breakout, in which a ball bounces around the screen and affects bricks as it bounces into them. The player controls a paddle to brick the ball from moving off the screen. Written in OpenJFX.",
        size: "",
        name: "Red Dots Dress",
        imageUrl:
          "https://i.ibb.co/GHvFLNc/Screenshot-2020-04-29-at-5-29-13-PM.png",
        price: 80,
      },
      {
        id: 27,
        ...
        imageUrl:
          "https://i.ibb.co/TBy5zsR/Screenshot-2020-04-29-at-5-30-37-PM.png",
        price: 45,
      },
      {
        id: 28,
        ...
        imageUrl:
          "https://i.ibb.co/G3TSqCd/Screenshot-2020-04-29-at-5-51-20-PM.png",
        price: 135,
      },

      {
        ...
        name: "White Blouse",
        imageUrl:
          "https://i.ibb.co/HKnnr1H/Screenshot-2020-04-29-at-5-37-10-PM.png",
        price: 20,
      },
    ],
  },
